		...
		<div class="col-sm-3 col-md-2">
			<div class="list-group">
				<a href='<spring:url value="/admin/dashboard.html"></spring:url>'
					...
					class="glyphicon glyphicon-dashboard"></span> Přehled</a> <a
					href='<spring:url value="/admin/articles.html"></spring:url>'
					class="list-group-item ${current == 'articles'?'active':'' }"><span
					class="glyphicon glyphicon-file"></span> Články</a> <a
					href='<spring:url value="/admin/categories.html"></spring:url>'
					class="list-group-item ${current == 'categories'?'active':'' }"><span
					class="glyphicon glyphicon-th-list"></span> Rubriky</a>
				<security:authorize access="hasRole('ROLE_ADMIN')">
					<a href='<spring:url value="/admin/users.html"></spring:url>'

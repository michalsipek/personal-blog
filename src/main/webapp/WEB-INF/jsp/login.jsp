...
<form class="form-signin" role="form" action='<spring:url value="j_spring_security_check"></spring:url>' method="POST">
        ...
        <input type="text" name="j_username" class="form-control" placeholder="Jméno" required autofocus>
        <input type="password" name="j_password" class="form-control" placeholder="Heslo" required>
